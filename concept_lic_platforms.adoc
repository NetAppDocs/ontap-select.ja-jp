...
---
= ONTAP Select のプラットフォームライセンスの提供
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.3+| ソリッドステートドライブ（SSD）を | ハードウェアRAID構成 | いいえ | はい。 | はい。 
...
2+| CPUファミリー  a| 
Intel Xeon E5-26xx v3（Haswell）以降

AMD EPYC Embedded 9004以降および8004
 a| 
Intel Xeon E5-26xx v3（Haswell）以降
...
====
.次の手順
link:concept_lic_workflow.html["ONTAP Selectライセンスの購入"]について学ぶ
