...
NOTE: ハイパーバイザーホストでのvSwitchの設定方法と高速インターフェース機能の詳細については、link:concept_nw_concepts_chars.html["ネットワーキングの詳細"]セクションを参照してください。
...
2つのNIC導入の詳細については、link:concept_nw_concepts_chars.html["ネットワーキングの詳細"]セクションを参照してください。
...
4つのNIC導入の詳細については、link:concept_nw_concepts_chars.html["ネットワーキングの詳細"]セクションを参照してください。
