...
ONTAP SelectはIntel Xeon Sandy BridgeおよびAdvanced Micro Devices（AMD）プロセッサをベースとしたCPUモデルをサポートしています。

詳細については、 https://mysupport.netapp.com/matrix["Interoperability Matrix Tool"^]を参照してください。
...
.プロセッサ
サポートされているマイクロプロセッサには、Intel Xeon サーバープロセッサと AMD プロセッサが含まれます。

詳細については、link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003["Intel Xeon プロセッサー"^]およびlink:https://www.amd.com/en/products/processors/server/epyc.html["AMD EPYC サーバー CPU"^]を参照してください。
...
.関連情報
link:concept_lic_platforms.html["ONTAP Select のプラットフォーム ライセンス製品"]について学ぶ
