...
[[ontap-features-licensed-by-default]]
[[licensed-ontap-features]]
...
+
link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/configure-netapp-volume-encryption-concept.html["外部キー管理の有効化と設定"^]について学ぶ。
...
* SnapMirror
+
ONTAP Selectは、非同期 SnapMirrorにおけるコンシステンシー グループをサポートしていません。
